...
class DocumentationController extends Controller
{
    ...
    public function getOrgDocsAct()
    {
        $ajaxData = $this->getEmployeeTblData();
        $result = $this->makeOrgDocActTblItems($ajaxData['totalItems'], $ajaxData['filterItems']);
        return $result;
    }
    ...
    private function makeOrgDocActTblItems($totalItems, $filterItems)
    {
        $iTotalRecords = count($totalItems);
        $iDisplayLength = intval($this->request['length']);
        $iDisplayLength = $iDisplayLength < 0 ? $iTotalRecords : $iDisplayLength;
