...
class DocumentationExpController extends Controller
{
    private $request;
    ...
    {
        return view('documentation.expiring.exp_index')->with('randNum', rand());
    }

    // ========================== BEGIN PUBLIC FUNCTIONS ==========================
    public function getExpDocList()
    {
        $whereConds = array();
        ...
        $result = $this->makeExpDocListTblItems($filterItems);
        return $result;
    }
    ...
    private function makeExpDocListTblItems($filterItems)
    {
