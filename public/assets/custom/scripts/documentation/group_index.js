var TableDocumentation = function () {
    ...
    var handleTblOrgDocs = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": BASE_URL + "/documentation/get-org-docs", // ajax source
                },
                "order": [
                    [1, "asc"]
    ...
    var handleTblEmpDocs = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": BASE_URL + "/documentation/get-emp-docs", // ajax source
                },
                "order": [
                    [1, "asc"]
                ],// set first column as a default sort by asc
    ...
    var handleTblExpDocs = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": BASE_URL + "/documentation/get-exp-docs", // ajax source
                },
                "order": [
                    [1, "asc"]
                ],// set first column as a default sort by asc
    ...
    var handleTblGroupDocs = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": BASE_URL + "/documentation/get-group-docs", // ajax source
                },
                "order": [
                    [1, "asc"]
                ],// set first column as a default sort by asc
        ...
        // handle datatable custom tools
        $('#tbl_group_docs_tools > a.tool-action').on('click', function () {
            var action = $(this).attr('data-action');
            grid.getDataTable().button(action).trigger();
        });
    }
    var handleOrgDocAct = function () {
