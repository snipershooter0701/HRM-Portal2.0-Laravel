var TableClient = function () {
    ...
    var handleLevelList = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": BASE_URL + "/settings/get_module_security", // ajax source
                },
                "order": [
                    [1, "asc"]
    ...
    var handleActivity = function () {
        ...
        grid.init({
            src: $("#tbl_organization_hierachy_activity"),
            onSuccess: function (grid, response) { },
            onError: function (grid) { },
            onDataLoad: function (grid) {
            },
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": BASE_URL + "/settings/level_list/get_activities", // ajax source
                },
                "order": [
                    [1, "asc"]
                ],// set first column as a default sort by asc
