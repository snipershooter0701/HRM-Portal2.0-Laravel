...
<div class="login-form">
    ...
    <div class="form-group">
        ...
        <div class="input-icon">
            ...
            <input id="login-email" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="input-icon">
            ...
            <input id="login-pwd" class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" />
        </div>
    </div>
...
@section('page_js')
<script src="{{ url('assets/custom/scripts/auth/login.js') }}" type="text/javascript"></script>
@endsection
