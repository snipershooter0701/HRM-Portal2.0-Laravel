...
@section('content')
<div id="panel-emp-doc-list" class="move-panel">
    @include('documentation.employee.emp_list')
</div>
@endsection
...
<script type="text/javascript">
    ...
    var PAGE_SUB_ID = "page_emp_document";
</script>
<script src="{{ url('assets/custom/scripts/documentation/emp_index.js?v=' . $randNum) }}" type="text/javascript"></script>
@endsection
