...
@section('content')
<div id="panel-exp-doc-list" class="move-panel">
    @include('documentation.expiring.exp_list')
</div>
@endsection
...
<script type="text/javascript">
    ...
    var PAGE_SUB_ID = "page_exp_document";
</script>
<script src="{{ url('assets/custom/scripts/documentation/exp_index.js?v=' . $randNum) }}" type="text/javascript"></script>
@endsection
