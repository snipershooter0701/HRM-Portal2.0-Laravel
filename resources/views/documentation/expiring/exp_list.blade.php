...
<div class="page-bar c-page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ url('/documentation/expiring') }}" class="btn-move-panel bread-active" data-panelname="panel-exp-doc-list">Expiring Documents</a>
        </li>
        <li>
                ...
                <div class="table-container">
                    <div class="row">
                        ...
                        <div class="col-md-4 actions">
                            <div id="tbl_exp_docs_tools" class="btn-group btn-group-devided clearfix tbl-ajax-tools" data-toggle="buttons">
                    ...
                    <table id="tbl_exp_docs" class="table table-striped table-bordered table-hover table-checkable">
                        <thead>
