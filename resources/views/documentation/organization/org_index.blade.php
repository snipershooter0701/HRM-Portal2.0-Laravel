...
<div id="panel-org-doc-list" class="move-panel">
    @include('documentation.organization.org_list')
</div>
<div id="panel-org-doc-create" class="move-panel display-none">
    @include('documentation.organization.org_create')
</div>
@endsection
...
<script type="text/javascript">
    ...
    var PAGE_SUB_ID = "page_org_document";
</script>
<script src="{{ url('assets/custom/scripts/documentation/org_index.js?v=' . $randNum) }}" type="text/javascript"></script>
@endsection
