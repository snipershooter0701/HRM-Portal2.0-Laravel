...
@section('content')
<div id="panel-request-list" class="move-panel">
...
<script type="text/javascript">
    ...
    var PAGE_SUB_ID = "page_request_list";
</script>
<script src="{{ url('assets/custom/scripts/employee/employee_request.js?v=' . $randNum) }}" type="text/javascript"></script>
@endsection
