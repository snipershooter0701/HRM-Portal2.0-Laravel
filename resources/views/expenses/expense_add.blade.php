...
<div class="page-bar c-page-bar">
    <ul class="page-breadcrumb">
        <li>
            <a href="javascript:;" class="page-move-btn bread-active" data-panelname="panel-expense-list">Add Expense(s)</a>
        </li>
    </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-body">
                            ...
                            <table id="tbl_add_expenses" class="table table-striped table-bordered table-hover table-checkable" style="margin-top: 0px !important;">
                                ...
                                <tbody> 
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:;" class="btn btn-xs btn-c-grey hide bill-del-1"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="form-actions text-right" id="add_expense_action">
                    ...
                    <button type="button" class="btn btn-sm btn-c-grey page-move-btn" data-panelname="panel-expense-list">Cancel</button>
                </div>
                <div class="form-actions text-right display-none" id="update_expense_action">
                    <button type="submit" class="btn btn-sm btn-c-primary" id="update_expense">Update</button>
                    <button type="button" class="btn btn-sm btn-c-grey page-move-btn" data-panelname="panel-expense-list">Cancel</button>
                </div>
                <div class="form-actions text-right display-none" id="view_expense_action">
                    <button type="button" class="btn btn-sm btn-c-grey page-move-btn" data-panelname="panel-expense-list">Cancel</button>
                </div>
            </div>
        </div>
