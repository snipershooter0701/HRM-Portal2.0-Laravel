...
<div class="page-bar c-page-bar">
    <ul class="page-breadcrumb">
        <li>
            <a href="javascript:;" class="page-move-btn bread-active" data-panelname="panel-expense-list">Expense List</a>
        </li>
    </ul>
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            <button type="button" class="btn btn-sm btn-c-primary" data-panelname="panel-expense-add" id="add_expense_btn"><i class="fa fa-plus-circle"></i> Add Expense </button>
        </div>
    </div>
</div>
<!-- END PAGE BAR -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 actions">
                            <div id="tbl_expenses_tools" class="btn-group btn-group-devided clearfix tbl-ajax-tools" data-toggle="buttons">
                                ...
                                <a class="btn-tbl-action page-move-btn" data-panelname="panel-import-employee"><i class="fa fa-upload"></i></a>
                                <a class="btn-tbl-action page-move-btn" data-panelname="panel-export-employee"><i class="fa fa-download"></i></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label class="expenses-total">
                                <input type="checkbox" class="icheck" data-checkbox="icheckbox_square-blue"> Total Expense(s)
                            </label>
