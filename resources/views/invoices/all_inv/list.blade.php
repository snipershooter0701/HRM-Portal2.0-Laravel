...
<div class="page-bar c-page-bar">
    ...
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            <button type="button" class="btn btn-sm btn-c-primary btn-move-panel mr-10" data-panelname="panel_invoice_add"><i class="fa fa-plus-circle"></i> Add Invoice </button>
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                ...
                <li>
                    <a href="javascript:;" class="btn-move-panel" data-panelname="panel_invoice_client_setting">
                    ...
                    <table id="tbl_invoices" class="table table-striped table-bordered table-hover table-checkable">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                ...
                                {{-- Received Amount --}}
                                <td>
                                    <input type="text" class="form-control form-filter input-sm margin-bottom-5" name="filt_rec_amount_from" placeholder="From">
                                    <input type="text" class="form-control form-filter input-sm" name="filt_rec_amount_to" placeholder="To">
                                </td>

                                {{-- Past Due in days --}}
                                <td>
                                    <input type="text" class="form-control form-filter input-sm margin-bottom-5" name="filt_pastdue_from" placeholder="From">
                                    <input type="text" class="form-control form-filter input-sm" name="filt_pastdue_to" placeholder="To">
                                </td>
