...
<div id="panel_invoice_inv_list" class="move-panel">
    @include('invoices.await_inv.inv_list')
</div>
@endsection
...
<script type="text/javascript">
    ...
    var PAGE_SUB_ID = "page_invoices_await_inv";

</script>
<script src="{{ url('assets/custom/scripts/invoices/await_inv/index.js?v=' . $randNum) }}" type="text/javascript"></script>
@endsection
