                    ...
                    <table id="tbl_await_invoices" class="table table-striped table-bordered table-hover table-checkable">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                ...
                                {{-- Total Hours --}}
                                <td>
                                    <input type="text" class="form-control form-filter input-sm margin-bottom-5" name="filt_total_hrs_from" placeholder="From">
                                    <input type="text" class="form-control form-filter input-sm" name="filt_total_hrs_to" placeholder="To">
                                </td>
