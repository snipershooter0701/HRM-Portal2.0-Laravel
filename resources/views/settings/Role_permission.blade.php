...
<div class="page-bar c-page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ url('/settings/role_permission') }}" class="btn-move-panel bread-active" >Role Permission</a>
        </li>
        <li>
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-body">
                <div class="table-container">
                    <div class="actions">
                        <button type="button" class="btn btn-sm btn-c-primary btn-move-panel mr-10" id="add_role"><i class="fa fa-plus-circle"></i> Add Role </button>
...
{{-- modal --}}
<div id="modal_add_role" class="modal fade" tabindex="-1" data-width="760">
