...
<div class="page-bar c-page-bar">
    <ul class="page-breadcrumb">
        <li>
            <a href="javascript:;" class="btn-move-panel bread-active">Invoice Setting</a>
        </li>
    </ul>
</div>
<!-- END PAGE BAR -->
...
<script type="text/javascript">
    ...
    var PAGE_SUB_ID = "page_settings_invoice";

</script>
<script src="{{ url('assets/custom/scripts/settings/invoice/index.js?v=' . $randNum) }}" type="text/javascript"></script>
@endsection
