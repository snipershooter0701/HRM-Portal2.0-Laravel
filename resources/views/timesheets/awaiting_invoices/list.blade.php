                    ...
                    <table id="time_await_invoices" class="table table-striped table-bordered table-hover table-checkable">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                ...
                                {{-- Invoice Frequency --}}
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" name="filt_inv_frequency">
                                </td>
                                ...
                                {{-- Total Hours --}}
                                <td>
                                    <input type="text" class="form-control form-filter input-sm margin-bottom-5" name="filt_total_hours_from">
                                    <input type="text" class="form-control form-filter input-sm" name="filt_total_hours_to">
                                </td>
